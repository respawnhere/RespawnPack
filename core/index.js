 ...
 * (adapters/claude-code, adapters/codex) and the kernel consume THIS; the reverse would
...
module.exports = {
  ...
  routing: require('./policy/routing.js'), // which model suits which task class, from the register's evidence
