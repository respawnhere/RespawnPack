...
This standard is grounded in a June 2026 research synthesis (the briefs `ai-writing-quality.md` and `ai-text-markers-and-human-preference.md`, kept in the RespawnPack development repository). The recurring finding across the literature: low-quality AI-assisted text usually fails not at the sentence level but at genre fit, specificity, evidence, stance, and authentic voice, and stylistic "tells" are weak signals that misfire on good human prose. Key sources (URLs verified against the live records on 2026-06-23):
