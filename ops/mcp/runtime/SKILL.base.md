...
Full routing rule and per-server annotations: `ops/README.md` in the pack repo ("Which way does a server connect?" — not installed into targets). Exact commands: that file's MCP server skills table and the [catalog page](../../../catalog/README.md).
